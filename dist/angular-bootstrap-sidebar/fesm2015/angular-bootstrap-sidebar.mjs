...
class ABSDirective {
    ...
    updateSidebarVisibility() {
        ...
        closeMenu === null || closeMenu === void 0 ? void 0 : closeMenu.remove();
    }
    checkActive(activate) {
        const navLink = this.el.nativeElement.querySelectorAll('.nav-link');
        navLink.forEach((a) => {
            var _a;
            const href = (_a = a.getAttribute('href')) === null || _a === void 0 ? void 0 : _a.toString();
            if (href) {
        ...
        menuData.forEach((menuItem) => {
            ...
            if (menuItem.subItems && menuItem.subItems.length > 0) {
                ...
                a.addEventListener('click', (event) => {
                    ...
                    const siblings = Array.from(((_a = parentLi.parentElement) === null || _a === void 0 ? void 0 : _a.children) || []);
